@echo off
REM Builds and (with "run") executes the lib/pursuit.hxx tests.
REM   firmware\tests\build_pursuit_test.bat [run]   - compile, optionally run
...
echo [ok] %HERE%build\test_pursuit.exe
