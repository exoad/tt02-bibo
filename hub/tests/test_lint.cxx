// Tests for the live style linter. See src/lint.hxx.
//
...
Void testCppOnly()
{
    ...
    check(lint::langOf("app_ui.cxx") == lint::Lang::LANG_CPP, ".cpp is C++");
    check(lint::langOf("editor.hxx") == lint::Lang::LANG_CPP, ".hpp is C++");
}
