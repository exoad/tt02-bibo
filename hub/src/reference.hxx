...
// ADDING A PAGE
//
// Write a function taking a Canvas, add one entry to the table in reference.cxx.
...
struct Canvas
{
    ...
    Void text(Float32 x, Float32 y, ImU32 col, const Char* s, Float32 pt = 11.0f, Align align = Align::ALIGN_LEFT) const;
    ...
    Void rect(Float32 x0, Float32 y0, Float32 x1, Float32 y1, ImU32 col, Float32 rounding = 0.0f, Float32 thickness = 1.0f) const;

    Void rectFilled(Float32 x0, Float32 y0, Float32 x1, Float32 y1, ImU32 col, Float32 rounding = 0.0f) const;

    Void line(Float32 x0, Float32 y0, Float32 x1, Float32 y1, ImU32 col, Float32 thickness = 1.0f) const;

    Void circle(Float32 x, Float32 y, Float32 r, ImU32 col, Bool filled = true, Float32 thickness = 1.0f) const;
};
