...
//
// ---------------------------------------------------------------------------
// WHY THIS EXISTS ALONGSIDE diagnostics.hpp
//
// diagnostics.hpp parses COMPILER output. It is exact, it is authoritative, and
...
//
// The firmware is C. It cannot use named casts, `Str`, or the shared.hpp
...
// diagnostics.hpp's.
//
// Pure: no file access, no globals, no ImGui. Tested in tests/test_lint.cpp.
