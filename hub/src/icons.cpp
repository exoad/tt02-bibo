...
static_assert(COUNT == static_cast<Int32>(Icon::ICON_COUNT),
              "icons.cpp: every Icon enumerator needs a file beside it");
...
// Integer scale only. See the note in icons.hpp: a fractional multiple of pixel
...
// See icons.hpp. Uses the same WIC decode the atlas does.
