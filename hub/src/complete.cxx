...
namespace cmpl
{
  namespace
  {
    ...
    const Item TABLE[] = {
        ...
        // ---- st77xx.h: the SPI colour display ----
        { "tftInit",        "Bool tftInit(Void)",
          "Reset and configure the panel. False only if the SPI pins are wrong.",
          Kind::KIND_FUNCTION },
        { "tftFill",        "Void tftFill(UInt16 colour)",
          "Whole screen to one colour.", Kind::KIND_FUNCTION },
        { "tftRect",        "Void tftRect(Int32 x, Int32 y, Int32 w, Int32 h, UInt16 colour)",
          "Filled rectangle, clipped to the panel.", Kind::KIND_FUNCTION },
        { "tftPixel",       "Void tftPixel(Int32 x, Int32 y, UInt16 colour)",
        ...
        { "gfxPresent",     "Void gfxPresent(Void)",
          ...
          Kind::KIND_FUNCTION },
        { "gfxClear",       "Void gfxClear(UInt16 colour)",
          "Whole canvas to one colour.", Kind::KIND_FUNCTION },
        { "gfxPixel",       "Void gfxPixel(Int32 x, Int32 y, UInt16 colour)",
        ...
        { "gfxTextAligned", "Void gfxTextAligned(Int32 x, Int32 y, const Utf8* s, GfxAlign a)",
          "Left, centred or right about x - so a changing value stays put.",
          Kind::KIND_FUNCTION },
        { "gfxTextColour",  "Void gfxTextColour(UInt16 fg)",
        ...
        { "gfxBlend",       "UInt16 gfxBlend(UInt16 a, UInt16 b, UInt8 t)",
          "Mix two colours; t is 0 for all a, 255 for all b.", Kind::KIND_FUNCTION },
