...
// not ui::sem - see the note on the two grounds in theme.hxx.
...
struct Paint
{
    ...
    Void rect(Float32 x0, Float32 y0, Float32 x1, Float32 y1, ImU32 fill, ImU32 edge, Float32 roundMm = 0.0f) const
    {
...
Void drawPico2W(ImDrawList* dl, const ImVec2& rmin, const ImVec2& rmax, Bool interactive, const Live& lv)
{
...
Float32 liveChip(ImDrawList* dl, ImFont* f, Float32 fs, Float32 right, Float32 y, const Char* label, const Char* value, ImU32 col, Bool dot, Bool lit = true)
{
